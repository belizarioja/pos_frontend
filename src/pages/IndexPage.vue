  ...
  <q-page class="bg-coral">
    <div class="col" style="">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12" style="display: flex; align-items: center;">
          <div class="botones row">
            <q-btn class="col-6" color="primary" icon="zoom_in" @click="abrirBuscarItem" label="Agregar item" style="font-size: 12px;"/>
            <q-btn class="col-6" color="secondary" icon-right="paid" label="Pagar" style="font-size: 12px;"/>
            <q-btn class="col-6" color="negative" icon="cancel" @click="openDeleteHolds" label="Cancelar venta" style="font-size: 12px;"/>
...
export default defineComponent({
  ...
  setup () {
    return {
      ...
      rowsproductos: [],
      holds: [],
      tasa: ref(sessionStorage.getItem('tasa')),
  ...
  methods: {
    async actualizarCantidad (item, accion) {
      ...
      this.totalusd = (this.total / this.tasa).toFixed(2)
